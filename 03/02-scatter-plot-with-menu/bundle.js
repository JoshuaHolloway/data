    ...
    return (
      React$1__default.createElement( React$1__default.Fragment, null,
        ...
        React$1__default.createElement( Dropdown, {
          options: attributes, id: "x-select", selectedValue: xAttribute, onSelectedValueChange: setXAttribute }),
        React$1__default.createElement( 'label', { for: "y-select" }, "Y:"),
        React$1__default.createElement( Dropdown, {
          options: attributes, id: "y-select", selectedValue: yAttribute, onSelectedValueChange: setYAttribute }),
