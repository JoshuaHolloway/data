...
(function (React, ReactDOM, d3) {
  ...
  var csvUrl = 'https://gist.githubusercontent.com/curran/b236990081a24761f7000567094914e0/raw/cssNamedColors.csv';
  var width = 960;
  var height = 500;
  var centerX = width / 2;
  ...
  ReactDOM.render(React__default.createElement(App, null), rootElement); // To compute the arcs manually (without d3.pie):
  // data.map((d, i) => (
  //   <path
